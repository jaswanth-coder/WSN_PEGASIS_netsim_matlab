...
function [route_order,cl_head,turn_in] = PEEGASIS(Did,NDid,X,Y,Pwr,length,width,n,sinkx,sinky,round,turn_in,max_energy)
%Input: 
...
for i=1:n        
   ...
   text(SN(i).x+(length/100),SN(i).y,num2str(SN(i).Nid));
 ...
 text(sinkx-(length/100),sinky-(width/100),'sink');
